...
Светлый интерьер с бежево-серой цветовой гаммой, элегантными светильниками и классическими молдингами создает атмосферу уюта и спокойствия. Идеально подходит для семейного отдыха или длительного проживания.`
  },
  {
    name: 'Бизнес-люкс',
    price: '22 000 ₽',
